...
reg = neighbors.KNeighborsRegressor(n_neighbors = 10, weights = 'distance').fit(xtrain.values, ytrain.values)
...
ax.set_title("KNN Prediction Accuracy", fontsize=24)
...
ax.set_title("KNN Point Differential Error", fontsize=24)
